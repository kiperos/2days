...
#
#usage:
# curl -O https://raw.githubusercontent.com/kiperos/2days/master/zipo.sh && chmod +x zipo.sh && ./zipo.sh
...
clear
  ...
  echo ""
cd
curl -O https://raw.githubusercontent.com/kiperos/2days/master/axx.7z
}
...
sleep 1
extract_axx
sed -i '$d' /root/axx/templates/crontab
